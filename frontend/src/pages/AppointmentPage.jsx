...
function AppointmentPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="bg-card border border-border rounded-2xl shadow-premium p-4 flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3">
